        ...
        #SET TITLE
            ...
            while col_index < des_col:
                ...
                while cellref.value:
                    ...
                    if(int(qualName)==1 and int(blockName)==1 and startDate!="01" and q1check ==False):
                        sheet.insert_rows(5,5)
                        print("Row Index: "+str(row_index))
...
tab1Label0 = Label(tab1frame,text = "Entry",fg="white",bg="grey10",font="Helvetica 20 bold").grid(row=1,column=0,padx=120)
...
tab1Label7a = Label(tab1frame2,text = "'20010'",fg=("grey50"),bg="grey26",font="Helvetica 15 bold").grid(row=7,column=2,pady=2)
global my_progress2
...
e2 = Entry(tab1frame2,width=5)
e2.grid(row=3,column=1)
e3 = Entry(tab1frame2,width=5)
e3.grid(row=4,column=1)
e4 = Entry(tab1frame2,width=10)
e4.grid(row=5,column=1)
e5 = Entry(tab1frame2,width=10)
e5.grid(row=6,column=1)
e6 = Entry(tab1frame2,width=8)
